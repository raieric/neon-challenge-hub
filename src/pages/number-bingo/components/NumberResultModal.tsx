...
const NumberResultModal = ({ timeElapsed, numbersCalledCount, mistakes, onRestart }: NumberResultModalProps) => {
    ...
    <>
      ...
      >
        ...
        >
          ...
          <p className="text-muted-foreground font-body">You Win!</p>
          <div className="space-y-2 text-muted-foreground font-body text-sm">
            ...
            <p>🎱 Numbers Drawn: <span className="text-foreground font-semibold">{numbersCalledCount}</span></p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link to="/">
              <Button variant="outline" className="font-display tracking-wider w-full">
                🏠 Back to Home
              </Button>
            </Link>
          </div>
...
export default NumberResultModal;
