  ...
  <footer className="relative z-10 py-6 text-center space-y-3">
    <p className="font-body text-sm text-muted-foreground/60 tracking-wide">
      ...
      <a
        ...
        className="font-semibold text-muted-foreground/80 hover:text-foreground hover:underline transition-colors duration-200"
      >
        jungey_sircar
      </a>
    </p>
    <div className="flex items-center justify-center gap-4">
      ...
      <a
        href="https://www.tiktok.com/@jungey_sircar"
        target="_blank"
        rel="noopener noreferrer"
        className="text-muted-foreground/60 hover:text-foreground transition-colors duration-200"
        aria-label="TikTok"
      ...
      <a
        href="https://wa.me/9779867995085"
        target="_blank"
        rel="noopener noreferrer"
        className="text-muted-foreground/60 hover:text-foreground transition-colors duration-200"
        aria-label="WhatsApp"
